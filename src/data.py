...
class TypeDataset(Dataset):
    def __init__(self, data: EMDataset, mode, lm='bert'):
        self.data = data
        self.mode = mode
        self.tokenizer = AutoTokenizer.from_pretrained(plms[lm])
        self.lm = lm
        self.sentences = []
        self.labels = []
        self.type_vocab = {}
    ...
    def init(self):
        ...
        for i, pair in enumerate(pairs):
            ...
            sentence = self.tokenizer(left, right, padding=True ,truncation=True, max_length=512)
