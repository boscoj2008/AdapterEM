...
def main():
    ...
    if training_args.do_predict and not training_args.do_train:
        model.load_adapter('adapters/snli_adapter', with_head=False,config=adapter_config)
    else:
        model.add_adapter('snli', adapter_config)
    ...
    if training_args.do_predict:
        ...
        for predict_dataset, task in zip(predict_datasets, tasks):
            ...
            if not is_regression:
                ...
                logger.info(f'Accuracy for {task}: {accuracy}')
            
    # save adapter after training 
    if training_args.do_train:
        model.save_adapter('./adapter/snli_adapter', 'snli')
